    ...
    <view class="profile-container">
      ...
      <view class="account-section">
        <view class="account-row">
          <view class="account-item" @click="navigateToPandaStore">
            ...
            <view class="account-value">{{ userData.pandaCoins }}</view>
          </view>
        ...
        >
          ...
          <view class="coupon-item">
            ...
            <view class="coupon-info">
              <text class="coupon-title">【新会员秒杀】免单券2</text>
          ...
          <view class="coupon-item">
            ...
            ></image>
            <view class="coupon-info">
              <text class="coupon-title">【新会员秒杀】买一赠一券2</text>
              <view class="coupon-price">
                <text class="price-value">9</text>
                <text class="price-unit">熊猫币</text>
              </view>
          ...
          <view class="coupon-item">
            ...
            ></image>
            <view class="coupon-info">
              <text class="coupon-title">鲜奶竹香乌龙单杯88折券</text>
              <view class="coupon-price">
                <text class="price-value">40</text>
                <text class="price-unit">熊猫币</text>
              </view>
              <button class="coupon-btn btn-exchange">立即兑换</button>
            </view>
          </view>
        </scroll-view>
      </view>
      ...
      <view class="member-services">
        ...
        <view class="services-grid">
          ...
          <view class="service-item" v-if="serviceItems.length % 4 !== 0">
            <!-- 预留空位，保持布局整齐 -->
          </view>
        </view>
      </view>
