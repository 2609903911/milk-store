      ...
      <scroll-view class="detail-scroll-area" scroll-y>
        ...
        <view class="product-detail">
          ...
          <view class="product-info">
            <view class="product-name">{{ product.name || "商品名称" }}</view>
            <view class="product-desc">{{ product.desc || "商品描述" }}</view>
            <view class="product-price">¥{{ product.price || "0.00" }}</view>
          </view>
          ...
          <view class="option-section">
            ...
            <view class="option-list">
              <view
                ...
                class="option-item"
                :class="{
                  'option-selected': selectedToppings.includes(topping.name),
                }"
                @tap="toggleTopping(topping.name)"
              >
                {{ topping.name }}
                <text class="option-price">+¥{{ topping.price }}</text>
              </view>
            </view>
          </view>
