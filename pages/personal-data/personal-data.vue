      ...
      <view class="user-form">
              ...
              <image
                ...
                :src="
                  userInfo.avatar.startsWith('http')
                    ? userInfo.avatar
                    : getFullUrl(userInfo.avatar) || '/static/images/avatar.png'
                "
                mode="aspectFill"
        ...
        <view class="form-item">
          ...
          <view class="input-area with-btn">
            ...
            <view class="action-btn" @tap="bindPhone">更换绑定</view>
          </view>
        </view>
        ...
        <view class="form-item">
          ...
          <view class="radio-group">
            <view class="radio-item" @tap="userInfo.gender = 'male'">
              <view
                class="radio"
                :class="{
            ...
            <view class="radio-item" @tap="userInfo.gender = 'female'">
              <view
                class="radio"
                :class="{
    ...
    >
      <view class="date-picker-container" @tap.stop>
        <view class="date-picker-header">
          ...
          <text class="confirm-btn" @tap="confirmDateSelection">确定</text>
        </view>
        <picker-view
          class="date-picker"
